    ...
    "paths": {
        ...
        "/card_in_collection": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/card.InCollection"
                            }
                        }
                    },
                    "500": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Card in collection",
